...
export const ProductImgThumbnail = ({ image, active, actived }: { image: ImageData, active: () => void, actived: boolean }) => {
    return (
        <div
            onMouseEnter={() => active()}
            className={`inline-flex items-center justify-center h-[70px] bg:h-[80px] lg:h-[60px] w-[calc(18%-4px)] lg:w-[calc(14%-4px)] rounded-lg mr-2 bg:mr-1 mb-2 bg:mb-1 border  cursor-pointer hover:border-gray-600 ${actived ? 'border-gray-800' : 'border-[#ddd]'}`}>
